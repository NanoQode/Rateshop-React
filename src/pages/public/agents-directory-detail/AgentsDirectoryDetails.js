...
import { agent1,adImage1,adImage2,adImage3,adImage4,adImage5,adImage6,adImage7,adImage8} from "../../../core/Images";
                                ...
                                <div className="agent-details">
                                    ...
                                    <div className="verified-icons">
                                        <ul>
                                            <li>
                                                <figure>
                                                    <img src={adImage1}></img>
                                                </figure>
                                            </li>
                                            <li>
                                                <figure>
                                                    <img src={adImage2}></img>
                                                </figure>
                                            </li>
                                            <li>
                                                <figure>
                                                    <img src={adImage3}></img>
                                                </figure>
                                            </li>
                                            <li>
                                                <figure>
                                                    <img src={adImage4}></img>
                                                </figure>
                                            </li>
                                            <li>
                                                <figure>
                                                    <img src={adImage5}></img>
                                                </figure>
                                            </li>
                                        </ul>
                                    </div>
